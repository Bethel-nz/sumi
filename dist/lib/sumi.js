...
declare global {
  export type MiddlewareName = ${middlewareNames.length > 0
...
usage: curl -X GET ${baseUrl}`;
    ...
    setupOpenAPIEndpoints() {
        ...
        if (this.docsConfig && !this.openapiConfig) {
            throw new Error("[Sumi] A 'docs' configuration was provided without a corresponding 'openapi' configuration. The documentation UI cannot be generated without the OpenAPI spec.");
        }
